...
wk.add({
  ...
  {
    "<leader>gs",
    icon = "", -- A common Git status icon (you can choose any Nerd Font icon)
  },
})
...
map("n", "<Leader>e", "<cmd> Neotree filesystem toggle<CR>", { desc = "neotree filesystem" })
map("n", "<Leader>gs", "<cmd> Neotree git_status toggle<CR>", { desc = "neotree git status" })
